...
<script type="text/javascript">
  ...
  $(function () {
    gobalDt =  $('#example1').DataTable({
        ...
        "sAjaxSource" : "<?php echo U('Paydetail/payLogList');?>",//通过ajax实现分页的url路径。
        "columns": [
          { data: "id"},
          { data: "nick_name"},
          { data: "total_fee"},
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="typeId" value="" />
          ...
          <div class="form-group">
            <label for="" class="control-label">收件电话:</label>
            <textarea class="form-control" name="p_amount"></textarea>
          </div>
          <div class="form-group">
            <label for="" class="control-label">收件人地址:</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="submitButton" class="btn save_btn">提交</button>
      </div>
    </div>
  </div>
</div>
